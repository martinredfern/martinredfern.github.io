...
$(document).ready(function() { // wait for document to load before javascript inits

    // ajaxify form submission via formspree - requires jQuery
    $(function() {
        var $contactForm = $('#contactform');
        var $messages = $('.messages');
        var $formButton = $('#contactformbutton');
        $contactForm.submit(function(e) {
        	...
        	$.ajax({
        		...
        		dataType: 'json',
        		beforeSend: function() {
        			$formButton.html("Sending message ...");
        		},
        		success: function(data) {
                    $formButton.css('display','none');
                    $messages.html('<p class="uk-text-center">Thanks for your message: you will receive a reply soon</p><button class="uk-button uk-button-secondary uk-align-center">OK</button>');
                    $messages.click(function(event) {
                        $messages.html('');
                        $contactForm.trigger('reset');
                        $formButton.html("Send message");
                        $formButton.css('display','block');
                    });
        		},
        		error: function(err) {
                    $formButton.css('display','none');
                    $messages.html('<p class="uk-text-center">There was a problem sending your message: please try again</p><button class="uk-button uk-button-secondary uk-align-center">OK</button>');
                    $messages.click(function(event) {
                        $messages.html('');
                        $formButton.html("Send message");
                        $formButton.css('display','block');
